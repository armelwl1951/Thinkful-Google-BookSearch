...
class SearchForm extends React.Component {
	...
	handleSubmit = (e) => {
		...
		let url = `https://www.googleapis.com/books/v1/volumes?key=AIzaSyAzwEjOKW0wpBXSnYTqylNyScDrhhP4mqA&q=${this.getSearchString()}&printType=${this.state.printType}`+filter;
